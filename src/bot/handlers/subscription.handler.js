  ...
  bot.start(async ctx => {
    ...
    try {
      ...
      await ctx.replyWithHTML(
        ...
        `Отправь /my_bookings, чтобы увидеть свои записи и отменить любую из них.\n` +
        `Отправь /my_subscriptions, чтобы настроить авто-бронирование на выходные — выбери день, тренировку и время, а мы забронируем место, как только расписание появится.\n\n` +
        `Ты подписан(а)! ✅`,
